...
if ($_POST['data']) {
    ...
    if ($db_name) {
        ...
        if (!$_POST['dset']) $dump->dropTable = false; // Dump DROP TABLE statement, default: true
        if ($_POST['export'] == 0 || $_POST['export'] == 1) $dump->createTable = true; // Dump CREATE TABLE statement, default: false
        if ($_POST['export'] == 0 || $_POST['export'] == 2) $dump->tableData = true; // Dump table data, default: false
        $dump->doDump();
