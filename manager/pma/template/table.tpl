<?php
    ...
    if($act=='empty') {
        echo "<div class='left'>" . $_var->home .
        "<a href='tables.php?db=".urlencode($db_name)."'>".pma_img('database.png').htmlentities($db_name)."</a> &#187; <a href='?$_url'>".pma_img('b_tbl.png').htmlentities($tb_name)."</a> &#187; ".pma_img('bd_empty.png')." $lang->Empty </div><hr size='1px'>
        <div class='topbar'>
